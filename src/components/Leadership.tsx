  ...
  return (
    <section id="about" className="max-w-6xl mx-auto px-6 py-20">
      ...
      <div className="flex flex-col sm:flex-row gap-8 items-start mt-4">
        ...
        <div>
          <p className="font-display italic text-xl sm:text-2xl text-burgundy-dark max-w-2xl leading-snug">
          ...
          <a
            href="#"
            className="inline-block mt-4 text-sm font-semibold text-burgundy border-b border-burgundy/40 hover:border-burgundy"
          >
