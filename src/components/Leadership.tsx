  ...
  return (
    <section id="about" className="mx-auto max-w-6xl px-6 py-20">
      ...
      <div className="mt-4 flex flex-col items-start gap-8 sm:flex-row">
        <div className="relative h-48 w-36 flex-none overflow-hidden rounded-xl border-2 border-gold-light bg-card">
        ...
        <div>
          ...
          <Link href="/about/presidents-message" className="mt-4 inline-block border-b border-pine/40 text-sm font-semibold text-pine hover:border-pine">Read the full message <span aria-hidden="true">→</span></Link>
        </div>
      </div>
    </section>
  );
