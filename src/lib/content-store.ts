...
const seed: ContentRecord[] = [
  ...
  { id: "project-scholarship", collection: "projects", title: "Student Scholarship", summary: "Supporting FJMU students facing financial hardship through $10,000 in annual scholarships and long-term contributions to the FJMU scholarship endowment.", featured: true, createdAt: "2022-01-01" },
