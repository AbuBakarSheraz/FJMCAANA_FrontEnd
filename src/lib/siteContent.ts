...
export const CONTENT_PAGES: ContentPage[] = [
  {
    ...
    sections: [
      ...
      { items: [
        ...
        { title: "Governance & reports", detail: "Constitution, bylaws, and annual reporting.", href: "/about/constitution-bylaws" },
      ] },
    ],
  },
  {
  ...
  {
    path: ["get-involved", "health-channel"], eyebrow: "Community Health", title: "FJMCAANA Health Channel", description: "Free online medical education and health awareness for the public in Pakistan, in collaboration with FJMU and Dr. Samina Toufeeq.",
    sections: [{ title: "Program", paragraphs: ["Prevention is Our Passion. Sessions were held live on Sundays at 8:00 p.m. PST on YouTube, Facebook, and Instagram."], items: [{ title: "Type 2 Diabetes: Is it reversible?", detail: "Dr. Fauzia Moyeen" }, { title: "Childhood Asthma", detail: "Dr. Nighat Mehdi" }, { title: "Healthy Living & Diet", detail: "Dr. Jasmine Zain" }, { title: "Sexually Transmitted Diseases", detail: "Dr. Shamsa Hamayun" }, { title: "Hypertension", detail: "Dr. Zaurez Khan" }] }],
  },
  {
...
export const LIFETIME_MEMBERS = [
  ["Dr. Raffia Qutab", "1991"], ["Dr. Aneela Aziz", "1990"], ["Dr. Azra Khan", "1984"], ["Dr. Bushra Ahmad", "1988"], ["Dr. Fauzia Rana", "1982"], ["Dr. Fizza Zahid Rafiq", "1996"], ["Dr. Ghazala Kazi", "1984"], ["Dr. Hibba Haider", "1997"], ["Dr. Madiha Khan", "2004"], ["Dr. Naheed Chaudhry", "1975"], ["Dr. Nighat Mehdi", "1986"], ["Dr. Noreen Shahbaz", "1987"], ["Dr. Nosheen Mazhar", "1989"], ["Dr. Sadaf Ali", "1996"], ["Dr. Saima Abbas", "1996"], ["Dr. Samina Hijab", "1986"], ["Dr. Shagufta Jabeen", "1986"], ["Dr. Shaheen Mian", "1977"], ["Dr. Shaista Hamid Ashai", "1986"], ["Dr. Shamim Malik", "1974"], ["Dr. Sumayya Amin", "1990"], ["Dr. Zaurez Khan", ""], ["Dr. Fauzia Anwar", "1986"], ["Dr. Sadia Khizer", "1995"], ["Dr. Tabassum Saeed", "1974"],
] as const;
