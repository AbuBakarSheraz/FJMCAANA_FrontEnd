...
export default function MembershipForm() {
  ...
  return (
    <form
      ...
      className="mt-14 bg-card/60 border border-pine/10 rounded-xl p-6 sm:p-8 max-w-xl"
    >
      <h3 className="font-display font-semibold text-lg text-pine-dark mb-1">Get on the list</h3>
      ...
      <div className="grid sm:grid-cols-2 gap-4">
        <input
          ...
          required
          className="w-full rounded-lg border border-pine/20 bg-white px-4 py-2.5 text-sm focus:outline-none focus:ring-2 focus:ring-pine/30"
        />
        <input
          type="email"
          name="email"
