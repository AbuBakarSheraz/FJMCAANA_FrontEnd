...
const PROJECTS = [
  ...
  {
    title: "Kashani Basti Food Hamper",
    FundsRaised: "$7,860",
  },
  {
    title: "Kashani Basti Dispensary",
    FundsRaised: "$2,060",
  },
  {
    title: "Vanguard",
  ...
  {
    title: "KP Fund",
    FundsRaised: "$8,360 → $10,000 (approx.)",
  },
  {
    title: "Afjog",
    FundsRaised: "$4,000",
...
export default function AnnualProjects2025Page() {
  return (
    <>
      <Navbar />
      ...
      <PageHeader
        ...
        title="Annual Projects — 2025"
        description="Our 2025 initiatives supported healthcare, education, community welfare, and relief efforts across Pakistan."
      />
        ...
        <section className="mx-auto max-w-7xl px-8 py-16 sm:px-2">
          ...
          <Reveal className="rounded-2xl bg-sage p-10 text-center">
            ...
            <p className="mx-auto mt-4 max-w-2xl text-lg leading-relaxed text-ink-soft">
              Every contribution helps us strengthen healthcare, education,
              and community support for people and families across Pakistan.
            </p>
